...
from src.embeddings.query import find_most_similar_node, DIM, build_lookup, get_embedding
...
def save_operations_to_json(ops: list, question: str, operation: str, original_answer: str, perturbed_answer: str, answer_similarity: float, original_subgraph, perturbed_subgraph, output_dir: str = "src/counterfactuals/counterfactual_results", filename: str = None, found: bool = True, cost: float = 0.0):
...
async def main():
    ...
    for idx, r in results.items():
        ...
        await find_counterfactuals(rag, question, context=context, operation="delete_node", max_cost=10)
