    ...
    if failed:
        ...
        for reason, count in reasons.most_common():
            label = {
                ...
                "unknown": "Could not find CFEs / checked everything",
            }.get(reason, reason)
...
def main():
    ...
    results = load_results("/home/gbalanos/GloRAG-Ex/code/src/counterfactuals/results/psp/hotpotqa/ft_delete_psp_k_5/hotpotqa/delete_ops_ft")
    if not results:
